...
/* ── Radio buttons: circular, purple, no background ── */
/* Native radio circle — purple accent */
...
/* Label row: transparent, no box, no highlight */
...
/* Checked label text: purple + bold */
...
/* Suppress any Streamlit wrapper backgrounds */
