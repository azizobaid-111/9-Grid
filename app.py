...
/* ── Clean company-purple tab underline + radio circles ── */

/* Tabs: remove manual button borders so only one underline appears */
...
/* The actual Streamlit/BaseWeb tab indicator */
.stTabs [data-baseweb="tab-highlight"],
[data-baseweb="tab-highlight"] {{
    background-color: #666EFF !important;
    height: 3px !important;
    border-radius: 3px 3px 0 0 !important;
}}

/* Radio group: force circle border, selected dot, and hover to company purple */
...
div[role="radiogroup"] [data-baseweb="radio"] input[type="radio"]:checked + div::after {{
    background-color: #FFFFFF !important;
}}

/* Prevent red fallback in newer Streamlit radio markup */



/* ── Safe final radio fix: purple circle only, no purple text background ── */
div[role="radiogroup"] input[type="radio"] {{
    accent-color: #666EFF !important;
}}
