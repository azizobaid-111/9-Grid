...
with st.sidebar:
    st.markdown(
        '<div style="font-size:12px;color:#94A3B8;margin-bottom:8px;">Use the filters below to update the dashboard.</div>',
        unsafe_allow_html=True,
    )
    if logo_b64:
        st.markdown(
...
st.markdown(
    ...
    f'border-radius:16px;padding:18px 28px;margin:6px 0 20px 0;'
