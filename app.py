...
/* ── FORCE BRAND PURPLE FOR TABS + RADIO ── */
...
[data-testid="stTab"][aria-selected="true"] * {{
    color: #666EFF !important;
    border-bottom-color: #666EFF !important;
}}
...
/* Radio buttons in bell curve section */
...
/* ── FINAL OVERRIDE: remove Streamlit default red from tabs and radio ── */
...
/* Streamlit radio selected circle */
...
/* Force Streamlit primary color variables */
:root {{
    --primary-color: #666EFF !important;
}}
